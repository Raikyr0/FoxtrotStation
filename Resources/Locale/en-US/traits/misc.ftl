...
examine-unrevivable-message = {CAPITALIZE(POSS-ADJ($entity))} wears a medical tag which notes that this individual can't be revived through conventional methods.
